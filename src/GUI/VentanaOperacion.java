...
public class VentanaOperacion extends JFrame implements ActionListener {
	...
	public VentanaOperacion() {
		...
		btnImprimir = new JButton("Imprimir Todo");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnCalcular) {
			...
			misProcesos.PedirNotas(nota1, nota2, nota3, nombre);

		} else if (e.getSource() == btnImprimir) {
			misProcesos.Imprimir();
		}

	}

	public static void Datos(int cantEstudiantesValidados, int cantGanan, int cantpierden, int cantPierden2,
			int cantRecupera) {
